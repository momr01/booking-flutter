...
class _BottomBarState extends State<BottomBar> {
  ...
  void _onItemTapped(int index) {
    //el index se pasa automaticamente, solo debemos traerlo
    setState(() {
  ...
  Widget build(BuildContext context) {
    //return Container();//si esta vacio todo se vera negro
    return Scaffold(
      // appBar: AppBar(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          type: BottomNavigationBarType
              .fixed, //los botones no cambian de tamaño al seleccionarlos
